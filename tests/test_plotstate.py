# -*- coding: utf-8 -*-
"""tests for storyline.states.PlotStateManager
"""
import unittest
...
# class PlotStateManagerTests(helpers.StateTests):
#     def setUp(self):
#         super(PlotStateManagerTests, self).setUp()

#         from storyline import states
#         self.state = states.PlotStateManager(
#             self.plot,
#             stack=[('foo', 'bar')],
#             situation=('foo', 'bar'),
#             messages=[],
